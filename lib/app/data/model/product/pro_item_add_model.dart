...
ProductitemAddModel productitemAddModelFromJson(String str) =>
    ProductitemAddModel.fromJson(json.decode(str));

String productitemAddModelToJson(ProductitemAddModel data) =>
