  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CommonPagePadding(
        child: Column(
          children: [
            DashboardHeaderCard(header: 'Dashboard', child: [
              DashboardCard(
                  lable: 'Employee',
                  onTap: () {},
                  count: '200',
                  color: const Color(0xff6e852d)),
              DashboardCard(
                  lable: 'Customer',
                  onTap: () {},
                  count: '120',
                  color: const Color(0xffe73268)),
              DashboardCard(
                  lable: 'Product',
                  onTap: () {},
                  count: '350',
                  color: const Color(0xff78428e))
            ]),
    ...
    //     header: 'Dashboard',
    //     child:
    //      controller.dashboardCount.map((item) {
