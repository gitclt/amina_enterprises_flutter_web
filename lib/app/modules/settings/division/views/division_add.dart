...
import 'package:amina_enterprises_flutter_web/app/modules/settings/division/controllers/division_controller.dart';
...
class DivisionAdd extends GetView<DivisionController> {
  const DivisionAdd({super.key});
    ...
    return Scaffold(
      ...
      body: CommonPagePadding(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          HomeAppBar(
            title: 'Home / Master / Division / Add',
            onClick: () {
