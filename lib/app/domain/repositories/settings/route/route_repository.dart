...
class RouteRepository extends NetworkApiServices {
  final _apiServices = NetworkApiServices();

  Future<Either<Failure, RouteModel>> getList() async {
    try {
      dynamic response = await getApi(SettingsUrl.routeListApi);

      if (response != null && response["status"] == true) {
        RouteModel res = RouteModel.fromJson(response);
...
//add
  Future<Either<Failure, ApiModel>> add(
    ...
    try {
      ...
      dynamic response = await _apiServices
          .postApi(data, SettingsUrl.routeAddApi, isJson: true);
  ...
  Future<Either<Failure, ApiModel>> edit({
    ...
    try {
      ...
      dynamic response = await _apiServices
          .putApi(data, SettingsUrl.routeEditApi, isJson: true);
  ...
  Future<Either<Failure, ApiModel>> delete({
    ...
    try {
      dynamic response =
          await _apiServices.deleteApi(body, SettingsUrl.routeDeleteApi);
