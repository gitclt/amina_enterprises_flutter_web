...
//view
  Future<Either<Failure, ProCategoryListModel>> getProGroupList() async {
    try {
      dynamic response = await _apiServices.getApi(
        SettingsUrl.proGroupListApi,
      );
...
//add
  Future<Either<Failure, ApiModel>> addProGroup(
    String name,
  ) async {
    try {
      var data = {
  ...
  Future<Either<Failure, ApiModel>> editProGroup({
    required String id,
  ...
  //delete
  Future<Either<Failure, ApiModel>> deleteProGroup({
    required String id,
  }) async {
    var body = {"id": id};
    try {
      dynamic response =
          await _apiServices.postApi(body, SettingsUrl.proGroupDeleteApi);
